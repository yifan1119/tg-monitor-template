...
WORK_SCHEDULE = {
    # v3.0.11(2026-04-30 客户调整):
    # - 周一~周五 晚段从 20:00-23:00 改成 20:00-22:00(下班早一小时)
    # - 周六从「11-13 / 15-20」简化成只 15:00-19:00 一段
    # - 周日仍全休
    0: [(11, 0, 13, 0), (15, 0, 19, 0), (20, 0, 22, 0)],  # 周一
    1: [(11, 0, 13, 0), (15, 0, 19, 0), (20, 0, 22, 0)],  # 周二
    2: [(11, 0, 13, 0), (15, 0, 19, 0), (20, 0, 22, 0)],  # 周三
    3: [(11, 0, 13, 0), (15, 0, 19, 0), (20, 0, 22, 0)],  # 周四
    4: [(11, 0, 13, 0), (15, 0, 19, 0), (20, 0, 22, 0)],  # 周五
    5: [(15, 0, 19, 0)],                                   # 周六
    6: [],                                                  # 周日休息
}
