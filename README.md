...
> 📌 **最新版**:v2.10.24.5(2026-04-22) — 📝 **补旧客户也能看到正确升级说明** — `release_notes.json` 的 `v2.10.24` key 改成四个 hotfix 累计说明,还没升 v2.10.24.4 的客户旧 regex 截断也能拿到完整说明
...
- **v2.10.24.5** (2026-04-22) — 当前稳定版 📝 **(文案补丁 — 旧客户也能看到正确升级说明)**
