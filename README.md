...
> 📌 **最新版**:v2.10.24.4(2026-04-22) — 🩹 **修后台升级弹窗展示错版本说明** — `update_checker` 版本号 regex 从三段扩到任意段(`v\d+(?:\.\d+)+`),四段版本号(如 `v2.10.24.3`)升级说明终于能正确展示
...
- **v2.10.24.4** (2026-04-22) — 当前稳定版 🩹 **(展示层修复 — 四段版本号升级说明)**
